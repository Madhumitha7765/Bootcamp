namespace DynamicArrayExercise
{
    public class Program
    {
        static void Main()
        {
            ...
            numbers.Add(3, 400);
            int value = numbers[2];
            Logger.Log($"Total Number Of Items in Array:{numbers.Count} ,Value:{value} at index:2");
            ...
            Logger.Log($"Total Number Of Items in Array:{stringItems.Count} , Value:{itemValue} at index:2");
        }
    }
}
